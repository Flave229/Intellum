...
ShaderController::ShaderController() : _vertexShader(nullptr), _pixelShader(nullptr), _layout(nullptr), _matrixBuffer(nullptr), _sampleState(nullptr)
{
}

ShaderController::ShaderController(const ShaderController& other) : _vertexShader(other._vertexShader), _pixelShader(other._pixelShader), _layout(other._layout), _matrixBuffer(other._matrixBuffer), _sampleState(other._sampleState)
{
}
...
bool ShaderController::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
...
bool ShaderController::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
